...
class SubscribeTest(TestCase):
    ...
    #     """Must use subscription/subscription_form.html""" # app/nome_do_form
    #     response = self.client.get('/inscricao/')
    ...
    def test_html(self):
        ...
        self.assertContains(self.resp, '<input', 6) # 5 times this field
...
class SubscribePostTest(TestCase):
    ...
    #                 email='henriquebastos@bastos.net', phone='21-99999-4444')
    #     response = self.client.post('/inscricao/', data)
    #
    #     self.assertEqual(302, response.status_code) # 302 = redirect page
    ...
    def test_subscription_email_body(self):
        ...
        self.assertIn('21-99999-4444', email.body)
